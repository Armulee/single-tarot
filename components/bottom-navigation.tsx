    ...
    return (
        <nav className="fixed bottom-0 left-0 z-50 md:hidden">
            <div className="relative">
                {/* Collapsed state - circular active icon */}
                {!isExpanded && (
                ...
                {/* Expanded state - horizontal expansion to the right */}
                {isExpanded && (
                    <div className="bg-card/5 backdrop-blur-sm border border-border/20 rounded-full p-2 flex items-center gap-2">
                        {/* Navigation items */}
