      ...
      <Card className="max-w-md w-full p-6 bg-card/20 backdrop-blur-sm border-border/30 card-glow">
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            {canClose ? (
              <Button onClick={handleClose} variant="ghost" size="sm" className="h-8 w-8 p-0 hover:bg-card/20">
                <X className="w-4 h-4" />
              </Button>
            ) : (
          ...
          <div className="text-center space-y-4">
            <div className="w-full h-32 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg flex items-center justify-center">
              <div className="text-center space-y-2">
                ...
                <p className="text-sm font-medium">Mystical Crystals</p>
                <p className="text-xs text-muted-foreground">Enhance your spiritual journey</p>
              </div>
            </div>
            <p className="text-xs text-muted-foreground">This ad helps keep Cosmic Tarot free for everyone</p>
          </div>

          {/* Upgrade CTA */}
          <div className="border-t border-border/20 pt-4">
            <div className="text-center space-y-3">
              <p className="text-sm text-muted-foreground">Tired of ads?</p>
              <Button
                onClick={onUpgrade}
                size="sm"
