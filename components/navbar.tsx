      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/reading" className="text-cosmic-light hover:text-white transition-colors">
              Reading
            </Link>
            <Link href="/about" className="text-cosmic-light hover:text-white transition-colors">
              About
            </Link>
            <Link href="/pricing" className="text-cosmic-light hover:text-white transition-colors">
              Pricing
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <Link href="/signin">
              <Button variant="ghost" className="text-cosmic-light hover:text-white hover:bg-cosmic-purple/20">
                Sign In
              </Button>
            </Link>
            <Link href="/signup">
              <Button className="bg-gradient-to-r from-cosmic-purple to-cosmic-blue hover:from-cosmic-purple/80 hover:to-cosmic-blue/80 text-white">
                Get Started
              </Button>
            </Link>
          </div>
