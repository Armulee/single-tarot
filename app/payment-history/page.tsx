...
export default function PaymentHistoryPage() {
    const { user } = useAuth()
    const { paymentHistory, loading, error, refreshPaymentHistory } = usePayment()
                ...
                <div className="container mx-auto px-4 py-8 max-w-4xl">
                    <Card className="p-8 text-center">
                        <div className="space-y-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-lg mb-2">Sign in to view payment history</h3>
                                <p className="text-muted-foreground mb-4">
                                    Create an account to access your payment history and billing information.
                                </p>
                ...
                <div className="container mx-auto px-4 py-8 max-w-4xl">
                    <Card className="p-8 text-center">
                        <div className="space-y-4">
                            ...
                            <div>
                                <h3 className="font-semibold text-lg mb-2">Error loading payment history</h3>
                                <p className="text-muted-foreground mb-4">{error}</p>
                                <Button onClick={refreshPaymentHistory} disabled={loading}>
                                    {loading ? (
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center gap-4 text-sm text-muted-foreground">
                                                <span>Payment ID: {payment.payment_intent_id}</span>
                                                <span>•</span>
