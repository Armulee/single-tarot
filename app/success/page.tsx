        ...
        <Card className="max-w-md w-full p-8 bg-card/10 backdrop-blur-sm border-border/20 card-glow text-center">
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <h1 className="font-serif font-bold text-2xl">Welcome to Premium!</h1>
              <p className="text-muted-foreground">
                Your subscription has been activated successfully. You now have access to unlimited readings and premium
                features.
              </p>
            </div>
            ...
            <div className="space-y-3 text-left">
              <h3 className="font-semibold text-center">What&apos;s unlocked:</h3>
            ...
            <div className="space-y-3">
              <Button asChild size="lg" className="w-full bg-primary hover:bg-primary/90 text-primary-foreground">
                <Link href="/reading">Start Your First Premium Reading</Link>
              </Button>
              <Button asChild variant="outline" className="w-full border-border/30 hover:bg-card/20 bg-transparent">
