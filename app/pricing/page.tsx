            ...
            <main className='relative z-10 max-w-6xl mx-auto px-6 py-16'>
                ...
                <div className='text-center space-y-6 mb-16'>
                    <div className='space-y-4'>
                        ...
                        <p className='text-xl text-muted-foreground max-w-2xl mx-auto text-pretty'>
                            Unlock deeper insights and remove limitations with
                ...
                <div className='grid md:grid-cols-2 gap-8 max-w-4xl mx-auto'>
                    {PRICING_PLANS.map((plan) => {
                        ...
                        const adjustedPrice =
                            plan.name === "Cosmic Premium" && isAnnual
                                ? "$2.39"
                                : plan.price
                    ...
                    <div className='grid gap-6'>
                        {[
                            ...
                            },
                            {
                                ...
                                answer: "Absolutely. We use Stripe for payment processing, which is PCI DSS compliant and uses industry-standard encryption to protect your data.",
                            },
                            {
                                question:
                                    "What happens if I exceed my monthly reading limit?",
                                answer: "Premium users get 5,000 monthly readings, which is more than enough for daily use. If you somehow exceed this limit, you can upgrade or wait for the next billing cycle.",
                            },
                        ].map((faq, index) => (
                            <Card
                                key={index}
